...
graph LR
    ...
    style Source fill:#E2A33E,stroke:#A87B2D,stroke-width:2px,color:#1a1a1a
    style Tests fill:#2d2d2d,stroke:#1a1a1a,stroke-width:1px,color:#fff
    style Docs fill:#EFC480,stroke:#E2A33E,stroke-width:2px,color:#1a1a1a
```
...
- Docker agent (removed) - was a similar CLI-first agent pattern
