...
**Status:** Planning
**Priority:** Medium
[Vote with 👍 on GitHub](https://github.com/amd/gaia/issues/201)
</Info>
...
This milestone is prioritized for Q1 alongside the Installer and Chat UI:

1. **AI assistants are mainstream now** - Claude Code, Cursor, and GitHub Copilot adoption is already high
2. **Developer experience is critical** - Making it easy to build with GAIA drives adoption
3. **MCP ecosystem is ready** - The protocol and tooling are mature
4. **Community demand** - AI-assisted development is a top request

Shipping the MCP Docs Server early ensures developers have great tooling from day one.
