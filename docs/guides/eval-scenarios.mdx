...
| `gaia_skills_capture` | `capture_skill` from pasted text / fixture URL / staged folder; code-inert honesty (tools deferred until `gaia skill promote`); audit-BLOCK refusal of a hostile paste |
