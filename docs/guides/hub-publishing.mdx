...
- [`connectors-demo/`](https://github.com/amd/gaia/tree/main/hub/agents/connectors-demo/python) — pulls real data through the connectors framework (Gmail, Calendar, Drive, GitHub).
